...
inline void GroupMember::set_allocated_user(::chat_proto::User* user) {
  ...
  if (user) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::chat_proto::User>::GetOwningArena(user);
...
inline std::string* GroupMember::release_role() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = role_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
